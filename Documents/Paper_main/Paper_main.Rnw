...
<<Plot_rho,warning=F, fig.pos="!h", fig.align="center", fig.height=3, fig.width=6, fig.cap="The behaviour of Type M and Type S errors as a function of statistical power in the case of Peardson's correlation $\\rho$." >>=
