...
\subsection{Publication Bias and Significance Filter}

On a concluding note, we would like to clarify the relationship of Design Analysis with publication bias and statistical significance filter.
